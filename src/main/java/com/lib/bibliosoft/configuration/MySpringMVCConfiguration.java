...
public class MySpringMVCConfiguration extends WebMvcConfigurationSupport {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        HandlerInterceptor handlerInterceptor = new HandlerInterceptor() {
            ...
            public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
                ...
                if (!StringUtils.isEmpty(session.getAttribute("islogin"))){
                    ...
                    response.sendRedirect("/lib_login");
                    return false;
                }
            }
        ...
        registry.addInterceptor(handlerInterceptor).addPathPatterns("/**").excludePathPatterns("/lib_login", "/admin_login", "/goAdminLogin",  "/librarian_login", "/code", "/404", "/500", "/static/**");
    }
    ...
    protected void addViewControllers(ViewControllerRegistry registry) {
        registry.addViewController( "/" ).setViewName( "lib_login");
